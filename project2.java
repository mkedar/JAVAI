...
public class project2 { 
    ...
    public static void list(Vector<Assignment> vector){  // list all of the assignments in the vector
        if(vector.size() == 0){ // check if vector is empty to display empty message
            System.out.println( "There is no assignment");
        }
        else{
            System.out.println("All assignments:"); // print all of the assignments if there are more than 0
            for (int i = 0; i < vector.size(); i++) {
                Assignment element = vector.get(i);
                System.out.println(element);
            }
        }
    }
    public static void stats(Vector<Assignment> vector) { //calculate and print the stats 
        if (vector.isEmpty()) {
        ...
        for (int i = 0; i < vector.size(); i++) { // calculate the smallest value, largest values, total postive/negative values and total values using a for loop
            Assignment currentAssignment = vector.get(i);
        ...
        System.out.println("Total number of assignments:          " + counter); // print out all of the calculated values
    ...
    while(true){ // while loop for the program to be able to be run indefiently 
        ...
        if(userInput.equals("exit")){
                ...
                System.exit(0); // exit program without an error
        }
        }
    }
}
